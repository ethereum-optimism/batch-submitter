...
interface RequiredEnvVars {
  ...
  MIN_L1_TX_SIZE_IN_BYTES: 'MIN_L1_TX_SIZE_IN_BYTES'
  // The maximum size in bytes of any L1 transactions generated by the batch submitter.
  MAX_L1_TX_SIZE_IN_BYTES: 'MAX_L1_TX_SIZE_IN_BYTES'
...
export const run = async () => {
  ...
  const txBatchSubmitter = new TransactionBatchSubmitter(
    sequencerSigner,
    l2Provider,
    parseInt(requiredEnvVars.MIN_L1_TX_SIZE_IN_BYTES, 10),
    parseInt(requiredEnvVars.MAX_L1_TX_SIZE_IN_BYTES, 10),
